    ...
    <div className={`min-h-screen w-full flex flex-col ${mounted ? "ready" : ""} ${jakartaSans.className}`}>
      ...
      <div className="flex-1 flex items-center justify-center bg-white px-6 min-h-screen">
        <div className="w-full max-w-md flex flex-col items-center text-center">
          ...
          {/* 404 with soft blurred shadow effect */}
          <div className="relative mb-8 sm:mb-10">
            <span
              aria-hidden="true"
              className="absolute inset-0 flex items-center justify-center text-[96px] sm:text-[140px] font-semibold text-black blur-xl opacity-70 select-none"
            >
              404
            </span>
            <span className="relative text-[96px] sm:text-[140px] font-semibold text-black leading-none select-none">
              404
            </span>
          </div>
          ...
          <p className="text-sm sm:text-base text-gray-400 leading-relaxed mb-8">
            ...
            <br className="hidden sm:block" /> the page may have moved.
          </p>

          <button
            type="button"
            className="bg-gray-900 hover:bg-gray-800 transition-colors text-white text-sm font-medium px-6 py-3 rounded-full"
          >
            Go back home
          </button>
